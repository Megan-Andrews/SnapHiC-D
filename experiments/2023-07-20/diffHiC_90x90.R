...
output_file <- paste0(result_directory, "diffHiC_Astro_MG_190315_21yr_90x90_results.csv")
...
# Read files
dfs = read_cool_dir(typeA_dir, typeB_dir, "chr22")
isets = make_iset(dfs)
