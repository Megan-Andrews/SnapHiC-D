...
def main():
    unprocessed_file_list = "/home/maa160/SnapHiC-D/experiments/2023-07-10/diffHiC/file_lists/Astro_10kb_file_list.txt"
    inputdir = "/project/compbio-lab/scHi-C/Lee2019/Human_single_cell_10kb_cool_rwr/"
    cell_type = "_Astro_"
    file_list =[]
    count = 0
